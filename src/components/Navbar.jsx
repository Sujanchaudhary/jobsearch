        ...
        <div className="flex gap-5">
          ...
          {login ? (
            ...
            <div className="flex gap-3">
              <button className="bg-white text-black h-10 px-6 rounded hover:bg-gray-400 hover:ease-in-out">
                Login
              </button>
              <button className="bg-white text-black h-10 px-6  rounded hover:bg-gray-400 hover:ease-in-ou">
                Register
              </button>
            </div>
          )}
